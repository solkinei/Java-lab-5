...
public class Clock extends Application {
    ...
    public void start(Stage stage) {
        ...
        Image image = new Image("file:3.jpg", 720, 720, false, false);
        ...
        secondHand.setTranslateX(357);   secondHand.setTranslateY(357); secondHand.setStroke(Color.RED); secondHand.setStrokeWidth(2);
        Line minuteHand   = new Line(0, 0, 0, -250);
        minuteHand.setTranslateX(357);   minuteHand.setTranslateY(357); minuteHand.setStroke(Color.RED); minuteHand.setStrokeWidth(4);
        Line hourHand   = new Line(0, 0, 0, -150);
        hourHand.setTranslateX(357);   hourHand.setTranslateY(357); hourHand.setStroke(Color.RED); hourHand.setStrokeWidth(10);
